...
const CoverImageSection = ({ backgroundImage, quote, author }) => {
  ...
  return (
    <div
      style={bgStyle}
      className="container lg:w-3/5 rounded-xl flex flex-col justify-end m-2 border-2 border-red-500"
    >
      <div className="inset-0 bg-black bg-opacity-20 flex items-center justify-center rounded-b-xl p-8 border-2 border-green-500">
